...
ssh us-west-1-1 'sudo rm -rf /mnt/ex*/e*/2*'
ssh us-west-1-2 'sudo rm -rf /mnt/ex*/e*/2*'
sed -i 's/"batchsize": 6,/"batchsize": 100,/g' experiments/osdi24/test-1s-15clients.json
...
ssh us-west-1-1 'sudo rm -rf /mnt/ex*/e*/2*'
ssh us-west-1-2 'sudo rm -rf /mnt/ex*/e*/2*'
sed -i 's/"batchsize": 100,/"batchsize": 800,/g' experiments/osdi24/test-1s-15clients.json
...
ssh us-west-1-1 'sudo rm -rf /mnt/ex*/e*/2*'
ssh us-west-1-2 'sudo rm -rf /mnt/ex*/e*/2*'
sed -i 's/"batchsize": 800,/"batchsize": 2000,/g' experiments/osdi24/test-1s-15clients.json
