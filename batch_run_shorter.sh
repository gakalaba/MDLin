...
ssh us-west-1-1 'sudo rm -rf /mnt/ex*/e*/2*'
ssh us-west-1-2 'sudo rm -rf /mnt/ex*/e*/2*'
sed -i 's/"batchsize": 6,/"batchsize": 50,/g' experiments/osdi24/test-9s-mp-15clients.json
...
ssh us-west-1-1 'sudo rm -rf /mnt/ex*/e*/2*'
ssh us-west-1-2 'sudo rm -rf /mnt/ex*/e*/2*'
sed -i 's/"batchsize": 50,/"batchsize": 200,/g' experiments/osdi24/test-9s-mp-15clients.json
...
ssh us-west-1-1 'sudo rm -rf /mnt/ex*/e*/2*'
ssh us-west-1-2 'sudo rm -rf /mnt/ex*/e*/2*'
sed -i 's/"batchsize": 200,/"batchsize": 400,/g' experiments/osdi24/test-9s-mp-15clients.json
...
ssh us-west-1-1 'sudo rm -rf /mnt/ex*/e*/2*'
ssh us-west-1-2 'sudo rm -rf /mnt/ex*/e*/2*'
sed -i 's/"batchsize": 400,/"batchsize": 1000,/g' experiments/osdi24/test-9s-mp-15clients.json
...
ssh us-west-1-1 'sudo rm -rf /mnt/ex*/e*/2*'
ssh us-west-1-2 'sudo rm -rf /mnt/ex*/e*/2*'
sed -i 's/"batchsize": 1000,/"batchsize": 3000,/g' experiments/osdi24/test-9s-mp-15clients.json
