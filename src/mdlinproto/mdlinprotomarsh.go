...
func (t *OldAccept) Unmarshal(rr io.Reader) error {
	var wire byteReader
	var ok bool
	if wire, ok = rr.(byteReader); !ok {
		wire = bufio.NewReader(rr)
...
// FinalAccept
func (t *FinalAccept) New() fastrpc.Serializable {
	return new(FinalAccept)
}

func (t *FinalAccept) Marshal(wire io.Writer) {
	// LeaderId  int32
  // Instance  int32
  // Ballot    int32
  // CmdTags  []Tag
...
// FinalAcceptReply
func (t *FinalAcceptReply) New() fastrpc.Serializable {
  return new(FinalAcceptReply)
}

func (t *FinalAcceptReply) Marshal(wire io.Writer) {
  // Instance  int32
  // OK        uint8
  // Ballot    int32
  var b [9]byte
...
// NaughtAccept
func (t *NaughtAccept) New() fastrpc.Serializable {
	return new(NaughtAccept)
}

func (t *NaughtAccept) Marshal(wire io.Writer) {
...
func (t *NaughtAccept) Unmarshal(rr io.Reader) error {
	// LeaderId int32
	// Instance int32
	// Ballot int32
	// Command []state.Command
...
// NaughtAcceptReply
func (t *NaughtAcceptReply) New() fastrpc.Serializable {
  return new(NaughtAcceptReply)
}

func (t *NaughtAcceptReply) Marshal(wire io.Writer) {
  // Instance  int32
  // OK        uint8
  // Ballot    int32
  var b [9]byte
...
func (t *NaughtAcceptReply) Unmarshal(wire io.Reader) error {
  var b [9]byte
	var bs []byte
	bs = b[:9]
	if _, err := io.ReadAtLeast(wire, bs, 9); err != nil {
